...
void map_niveau2(char map[N][M]){
	...
	creer_piece(map, rand_a_b(3, 8), rand_a_b(3, 8), 18, 25, 10, 16);
	
	/* Création de la deuxième pièce */
	creer_piece(map, rand_a_b(3, 8), rand_a_b(42, 47), 10, 15, 8, 13);
	
	/* Création de la troisième pièce */
	creer_piece(map, rand_a_b(3, 8), rand_a_b(82, 87), 18, 25, 10, 16);
	
	/* Création de la quatrième pièce */
	creer_piece(map, rand_a_b(27, 32), rand_a_b(3, 8), 35, 45, 12, 17);

	/* Création de la cinquième pièce */
	creer_piece(map, rand_a_b(25, 30), rand_a_b(62, 67), 34, 44, 13, 18);
}
